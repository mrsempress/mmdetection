...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'pkl/train_large.pkl',
        ...
        extra_aug=dict(
            ...
            #     ratio_range=(1, 4)),
            random_crop=dict(
                min_ious=(0.7, 0.9), min_crop_size=0.9)),
...
log_level = 'INFO'
work_dir = 'centernet_r18_finetune_large'
load_from = '/private/ningqingqun/mmdet/outputs/no31_36/centernet_r18_adam_no_crop_1129_1920_gpu9/epoch_40_iter_8441.pth'
resume_from = None
workflow = [('train', 1)]
