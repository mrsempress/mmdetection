...
model = dict(
    ...
    bbox_head=dict(
        type='TTFXHead',
        genotype='work_dirs/1910/1016_T18_8EPOCH_GUMBEL_5E4_NONE_NOBETA_1X/ttfnext18_search_gumbel_non_wd5e4_1x_1016_1126/search.pkl',
...
log_level = 'INFO'
work_dir = 'ttfnext18_gumbel_5e4_non_nobeta_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
