...
model = dict(
    ...
    bbox_head=dict(
        type='TTFXHead',
        genotype='work_dirs/1909/0924_S18_8EPOCH_GUMBEL_1E3LR_NONE_1X/ttfnext18_search_gumbel_non_1e3lr_1x_0924_1153/search.pkl',
...
log_level = 'INFO'
work_dir = 'ttfnext18_gumbel_1e3_non_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
