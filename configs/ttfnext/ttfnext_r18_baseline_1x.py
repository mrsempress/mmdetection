...
model = dict(
    ...
    bbox_head=dict(
        type='TTFXHead',
        genotype=[('conv_3x3', 0), ('none', 1), ('conv_3x3', 1), ('none', 2), ('conv_3x3', 2), ('mdcn_3x3', 3),
                  ('conv_3x3', 4), ('none', 5), ('conv_3x3', 5), ('mdcn_3x3', 6),
                  ('conv_3x3', 7), ('mdcn_3x3', 8)],
        inplanes=(64, 128, 256, 512),
        planes=(64, 128, 256, 512),
        ops_list=('none', 'skip_connect', 'conv_1x1', 'conv_3x3', 'sep_conv_3x3',
...
log_level = 'INFO'
work_dir = 'ttfnext18_baseline_1x'
load_from = None
resume_from = None
workflow = [('train', 1)]
