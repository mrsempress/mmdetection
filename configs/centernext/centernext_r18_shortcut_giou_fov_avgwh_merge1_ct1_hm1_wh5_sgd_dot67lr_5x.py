...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.001 / 1.5, momentum=0.9, weight_decay=0.0001)
...
log_level = 'INFO'
work_dir = 'centernext_r18_shortcut_giou_fov_avgwh_merge1_ct1_hm1_wh5_sgd_1dot5lr_5x'
load_from = None
resume_from = None
workflow = [('train', 1)]
