...
model = dict(
    type='CenterNet',
    pretrained='/home/liuzili/.cache/torch/checkpoints/resnet18_tridentc5.pth',
    backbone=dict(
        type='ResNet',
        depth=18,
        num_stages=4,
...
log_level = 'INFO'
work_dir = 'cxt18_triresc5nos_awhloff16_nobiaswd_3lr_wd2e4_ext_hmi_5x'
load_from = None
resume_from = None
workflow = [('train', 1)]
