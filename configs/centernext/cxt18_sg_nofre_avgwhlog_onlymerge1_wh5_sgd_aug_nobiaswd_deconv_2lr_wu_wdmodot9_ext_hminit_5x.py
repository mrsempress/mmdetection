...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.002, momentum=0.9, weight_decay=0.00005,
...
log_level = 'INFO'
work_dir = 'cxt18_sg_nofre_avgwhlog_onlymerge1_wh5_sgd_noaug_nobiaswd_deconv_2lr_warmup_wdmodot9_ext_hminit_5x'
load_from = None
resume_from = None
workflow = [('train', 1)]
