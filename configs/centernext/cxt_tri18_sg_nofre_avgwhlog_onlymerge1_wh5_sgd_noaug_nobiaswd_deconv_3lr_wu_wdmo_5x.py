...
model = dict(
    type='CenterNet',
    pretrained='/home/liuzili/.cache/torch/checkpoints/resnet18_trident.pth',
    backbone=dict(
        type='ResNet',
        depth=18,
        num_stages=4,
...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.003, momentum=0.8, weight_decay=0.00005,
...
log_level = 'INFO'
work_dir = 'cxt18_sg_nofre_avgwhlog_onlymerge1_wh5_sgd_noaug_nobiaswd_deconv_3lr_warmup_wdmo_5x'
load_from = None
resume_from = None
workflow = [('train', 1)]
