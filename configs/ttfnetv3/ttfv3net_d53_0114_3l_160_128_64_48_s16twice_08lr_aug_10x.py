...
model = dict(
    ...
    bbox_head=dict(
        ...
        hm_weight=(1.4, 1.4, 1.),
        wh_weight=(7., 7., 5.),
        length_range=((128, 512), (48, 160), (1, 64)),
...
load_from = 'work_dirs/2001/0219_ttfv353_0114_3l_160_128_64_48_s16twice_08lr_aug_10x/work_dirs/ttfv3net_r53_10x_0222_1546/epoch_120.pth'
resume_from = None
workflow = [('train', 1)]
