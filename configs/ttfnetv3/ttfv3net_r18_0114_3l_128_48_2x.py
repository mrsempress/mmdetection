...
lr_config = dict(
    ...
    warmup_ratio=1.0 / 5,
    step=[18, 22])
checkpoint_config = dict(save_every_n_steps=200, max_to_keep=1, keep_in_n_epoch=[18])
# yapf:disable
...
load_from = None
resume_from = 'work_dirs/2001/0123_ttfv3_18_0114_3L_128_48_1x/work_dirs/ttfv3net_r18_1x_0123_1221/epoch_9.pth'
workflow = [('train', 1)]
