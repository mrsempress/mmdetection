...
model = dict(
    ...
    bbox_head=dict(
        ...
        hm_weight=(1.4, 1.4, 1.),
        wh_weight=(7., 7., 5.),
        length_range=((128, 512), (48, 160), (1, 60)),
        train_branch=(True, True, True),
        inf_branch=(True, True, True),
        use_simple_nms=True,
        fast_nms=True,
        # use_fast_nms_v2=True,
        # trand_nms=True,
        max_objs=128,
        conv_cfg=None,
...
log_level = 'INFO'
work_dir = './work_dirs/ttfv3net_r18_10x'
load_from = 'work_dirs/2001/0130_ttfv318_0114_3l_160_128_64_48_s16twice_aug_10x/work_dirs/ttfv3net_r18_10x_0130_2359/epoch_120.pth'
resume_from = None
workflow = [('train', 1)]
