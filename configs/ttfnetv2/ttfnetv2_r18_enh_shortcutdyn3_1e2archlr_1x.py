...
model = dict(
    ...
    bbox_head=dict(
        ...
        b2_max_length=64,
        inf_branch=['b1', 'b2'],
        shortcut_conv_cfg=dict(type='DynDilaConv', param_multiply=10., alpha_scale=1e-4, split=8,
                               tau_end_epoch=3, tau=(10., 1.), bias=True),
...
optimizer = dict(
    ...
    paramwise_options=dict(bias_lr_mult=2., bias_decay_mult=0.,
                           arch_lr_mult=1e2, arch_decay_mult=0.))
