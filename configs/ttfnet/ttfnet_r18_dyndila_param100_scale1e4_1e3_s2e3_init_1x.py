...
model = dict(
    ...
    backbone=dict(
        ...
        depth=18,
        num_stages=4,
        local_conv_cfg=dict(type='DynDilaConv', param_multiply=100., alpha_scale=1e-4,
                            split=8, tau_start_epoch=2, tau_end_epoch=3,
                            init_values=(7., 2., 1., 0.5, 0.3, 0.2, 0.1, 0.1)),
