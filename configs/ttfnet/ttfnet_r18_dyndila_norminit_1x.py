...
model = dict(
    ...
    backbone=dict(
        ...
        depth=18,
        num_stages=4,
        local_conv_cfg=dict(type='DynDilaConv'),
...
load_from = 'work_dirs/1910/1013_ttf18_scartch_dyndila_10x/ttfnet18_scratch_dyndila_1x_1013_0927/epoch_49_iter_89400.pth'
resume_from = None
workflow = [('train', 1)]
