...
model = dict(
    ...
    backbone=dict(
        ...
        depth=18,
        num_stages=4,
        local_conv_cfg=dict(type='DynDilaConv', alpha_scale=1., split=8, dilation_choice=(1, 2),
                            use_split=False,
                            auto_lr=True, tau=(10, 1), tau_end_epoch=2, init_values=(1., 1.)),
...
optimizer = dict(type='SGD', lr=0.002, momentum=0.9, weight_decay=0.0004,
                 paramwise_options=dict(bias_lr_mult=2., bias_decay_mult=0.,
                                        arch_lr_mult=2e6, arch_decay_mult=0., arch_mom_mult=0.4))
