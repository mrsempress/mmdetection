...
lr_config = dict(
    ...
    warmup_ratio=1.0 / 5,
    step=[140, 154])
checkpoint_config = dict(save_every_n_steps=200, max_to_keep=1, keep_in_n_epoch=[140])
...
log_level = 'INFO'
work_dir = './work_dirs/ttfnet53_16x'
load_from = None
resume_from = 'work_dirs/1911/1101_ttf53_pretrain_aug_10x/work_dirs/ttfnet53_10x_1104_2338/epoch_90.pth'
workflow = [('train', 1)]
