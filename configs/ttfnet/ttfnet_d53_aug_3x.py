...
lr_config = dict(
    ...
    warmup_ratio=1.0 / 5,
    step=[9, 11])
checkpoint_config = dict(save_every_n_steps=200, max_to_keep=1, keep_every_n_epochs=27)
# yapf:disable
...
log_level = 'INFO'
work_dir = 'ttfnet53_1x'
load_from = 'work_dirs/1909/1010_ttf53_aug_2x/ttfnet53_1x_1010_2326/epoch_22.pth'
resume_from = None
workflow = [('train', 1)]
