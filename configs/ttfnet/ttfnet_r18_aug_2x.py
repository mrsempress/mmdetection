...
lr_config = dict(
    ...
    warmup_ratio=1.0 / 5,
    step=[18, 22])
checkpoint_config = dict(save_every_n_steps=200, max_to_keep=1, keep_every_n_epochs=22)
...
load_from = None
resume_from = 'work_dirs/1909/1009_ttf18_aug_1x/work_dirs/ttfnet18_1x_1009_1131/epoch_9.pth'
workflow = [('train', 1)]
