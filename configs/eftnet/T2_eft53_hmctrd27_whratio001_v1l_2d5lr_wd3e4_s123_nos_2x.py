...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.0025, momentum=0.9, weight_decay=0.0003,
...
log_level = 'INFO'
work_dir = 'eft53_htct027_whratio001_v1l_2d5lr_wd3e4_s123_nos_2x'
load_from = None
resume_from = 'work_dirs/1908/0806_T2_eft53_V1L_HMCR027_RATIO001_2D5LR_AGN_1X/eft53_htct027_whratio001_v1l_2d5lr_wd3e4_s123_nos_1x_0806_2103/epoch_9.pth'
workflow = [('train', 1)]
