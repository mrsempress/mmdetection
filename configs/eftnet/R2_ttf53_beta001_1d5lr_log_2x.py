...
data = dict(
    ...
    test=dict(
        ...
        pipeline=test_pipeline))
# optimizer
optimizer = dict(type='SGD', lr=0.0015, momentum=0.9, weight_decay=0.0004,
...
log_level = 'INFO'
work_dir = 'ttf53_beta001_1d5lr_log_2x'
load_from = None
resume_from = None #  'work_dirs/1908/0809_R2_ttf53_BETA001_1D5LR_LOG/ttf53_beta001_1d5lr_log_1x_0809_1800/epoch_9.pth'
workflow = [('train', 1)]
