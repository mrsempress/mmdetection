...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        task=data_task,
        ann_file=data_root + 'ImageSets/train190902_B50_2.txt',
...
checkpoint_config = dict(
    save_every_n_steps=500, max_to_keep=1, keep_every_n_epochs=4)
...
log_level = 'INFO'
work_dir = 'centernet_r34_8cls_merge_B50_2'
load_from = None
#load_from = '/private/ningqingqun/torch/centernet/r34_epoch_24_iter_126179.pth'
resume_from = '/private/ningqingqun/mmdet/outputs/fake_label/centernet_r34_8cls_merge_B10_2_0320_1008_gpu3/epoch_6_iter_28254.pth'
workflow = [('train', 1)]
