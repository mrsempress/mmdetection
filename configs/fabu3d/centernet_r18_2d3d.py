...
dataset_type2 = 'Vision2DDataset'
data_root2 = 'data/fabu2d/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=[
        ...
        dict(
            type=dataset_type2,
            ann_file=data_root2 + 'ImageSets/train190902_front.txt',
            img_prefix=data_root2 + 'images/',
            img_scale=(1280, 800),
            img_norm_cfg=img_norm_cfg,
            size_divisor=32,
            flip_ratio=0.5,
